...
import { Download, FileText, FileDigit, Files, Wand2 } from 'lucide-react';
...
const App = () => {
  ...
  const download = async (type) => {
    try {
      ...
      // fallback: plain text export on client
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-950 text-slate-900 dark:text-slate-100">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="order-1 lg:order-2 space-y-6">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-4 md:p-6">
              ...
              <p className="text-xs text-slate-500 mt-2">ATS-optimized exports with clean structure.</p>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-4 md:p-6">
              ...
              <ul className="text-sm list-disc ml-5 space-y-1 text-slate-600 dark:text-slate-300">
                ...
                <li>Keep to one page unless you have 8+ years experience.</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <style>{`
        .input { @apply w-full rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-3 py-2 text-sm; }
        .btn { @apply inline-flex items-center justify-center gap-2 rounded-lg border border-slate-200 dark:border-slate-800 px-3 py-2 text-sm hover:bg-slate-50 dark:hover:bg-slate-800 transition; }
